...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div
          className="min-h-screen bg-gradient-to-br from-tech-primary/10 to-tech-secondary/10 flex items-center justify-center p-8"
          role="alert"
          aria-live="assertive"
        >
          <div className="max-w-2xl w-full bg-white dark:bg-slate-800 border-2 border-tech-primary/20 p-12 rounded-[2rem] shadow-2xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="bg-tech-primary/10 p-4 rounded-2xl">
                <svg
                  className="w-12 h-12 text-tech-primary"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <h1 className="text-4xl font-display font-black text-slate-900 dark:text-white">
                Navigation <span className="text-tech-primary">Error</span>
              </h1>
            </div>
            <p className="text-slate-600 dark:text-slate-400 font-medium mb-8 leading-relaxed">
              We encountered an unexpected detour while loading the technology roadmaps. Don't
